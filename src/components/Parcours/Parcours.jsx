                    ...
                    <article className="parcours__box">
                        <h2 className="parcours__box-title">Formation</h2>
                            ...
                            <ul className="parcours__list">
                                <li className="parcours__box-text"><strong>Développeur Web & Web Mobile</strong> - Ecole Oclock - 2023/2024</li>
                                <p className="parcours__box-text">Titre professionnel de niveau 5 (Bac+2) </p>
                                <li className="parcours__box-text"><strong>Master 2 Economie - Toulouse School Of Management</strong> - 2012/2014</li>
                            </ul>
                    </article>
                    <article className="parcours__box">
